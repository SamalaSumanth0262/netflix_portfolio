...
import { FaTrophy, FaCode, FaBriefcase, FaCertificate, FaProjectDiagram, FaEnvelope, FaMusic, FaBook } from 'react-icons/fa';
...
const topPicksConfig = {
  recruiter: [
    { title: "Career Highlights", imgSrc: "https://picsum.photos/seed/careerhighlights/250/200", icon: <FaTrophy />, route: "/career-highlights" },
  ...
  stalker: [
    { title: "Career Highlights", imgSrc: "https://picsum.photos/seed/careerhighlights/250/200", route: "/career-highlights", icon: <FaTrophy /> },
